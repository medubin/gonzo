...
type UserService interface {
	...
	GetUser(ctx context.Context, body *interface{}, cookie cookies.Cookies, url url.URL[GetUserUrl]) (*DetailedUser, error)
	// All other urls can contain a body
	// body and return always refer to a struct type
	CreateUser(ctx context.Context, body *CreateUserRequest, cookie cookies.Cookies, url url.URL[interface{}]) (*User, error)
	...
	ListUsers(ctx context.Context, body *interface{}, cookie cookies.Cookies, url url.URL[interface{}]) (*UserCollection, error)
	SearchUsers(ctx context.Context, body *interface{}, cookie cookies.Cookies, url url.URL[interface{}]) (*UserCollection, error)
	GetUsersByRole(ctx context.Context, body *interface{}, cookie cookies.Cookies, url url.URL[GetUsersByRoleUrl]) (*UserCollection, error)
}
...
type NotificationService interface {
	GetUserNotifications(ctx context.Context, body *interface{}, cookie cookies.Cookies, url url.URL[GetUserNotificationsUrl]) (*[]Notification, error)
}
