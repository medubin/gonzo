...
var _validatePattern_CreateUserRequest_Username = regexp.MustCompile("^[a-z0-9_]+$")
...
func (v CreateUserRequest) Validate() error {
	...
	if v.Username != nil {
		if len(*v.Username) < 3 {
			return gerrors.InvalidArgumentError("field 'Username' must be at least 3 characters")
		}
		if len(*v.Username) > 32 {
			return gerrors.InvalidArgumentError("field 'Username' must be at most 32 characters")
		}
		if !_validatePattern_CreateUserRequest_Username.MatchString(*v.Username) {
			return gerrors.InvalidArgumentError("field 'Username' does not match required pattern")
		}
	}
	if v.Email == nil {
	...
	if v.Password != nil {
		if len(*v.Password) < 8 {
			return gerrors.InvalidArgumentError("field 'Password' must be at least 8 characters")
		}
		if len(*v.Password) > 128 {
			return gerrors.InvalidArgumentError("field 'Password' must be at most 128 characters")
		}
	}
	return nil
}
...
func (v ConflictError) Validate() error {
	return nil
}
